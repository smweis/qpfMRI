...
disp(strcat('Waiting for first ',myQpfmriParams.baselineMaxBOLDInitial,'trials'));
x = 0;
while x <= myQpfmriParams.baselineMaxBOLDInitial
...
qpfmriResults.stimulusVec = nan(1,x);
% This allows us to store how each trial was generated
qpfmriResults.stimulusVecTrialTypes = cell(1,x);
...
for tt = myQpfmriParams.baselineMaxBOLDInitial:myQpfmriParams.nTrials
...
%             display(qpfmriResults.stimulusVec(tt)); % nextStim
...
%     end
        ...
        thePacket.response.values = timeseries(1:tt);
