...
modelNames = {'doeTemporalModel','watsonTemporalModel','logistic','nakaRushton','orthBasisSet'};
...
modelParamNames.orthBasisSet = {'firstOrder','secondOrder','thirdOrder','beta','sigma'};
