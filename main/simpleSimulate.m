function [qpfmriResults]=simpleSimulate(myQpfmriParams, myQpParams, varargin)
%% [qpfmriResults]=simpleSimulate(myQpfmriParams, varargin)
...
paramsDomain.sigma = makeDomain(0.0001,1,8);

% Specify a stimulus domain and whether it spaced linear or log.
stimulusDomain = {makeDomain(.01,1,15)};
...
'maxBOLDInitialGuess',maxBOLDInitialGuess,'baselineStimulus',baselineStimulus,...,
...
% Run the simulation. 
[qpfmriResults]=simpleSimulate(myQpfmriParams,myQpParams,'showPlots',showPlots);
